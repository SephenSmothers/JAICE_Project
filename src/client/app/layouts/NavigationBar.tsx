            ...
            <div className="fixed group left-0 w-[5rem] hover:w-[15rem] h-full bg-[var(--color-blue-1)] flex flex-col items-center p-2 gap-2">
              ...
              <header>
                <h1 className="text-xl font-bold" style={{ fontFamily: 'var(--font-title)' }}>
                  <span className="group-hover:hidden" style={{ fontFamily: 'inherit', fontSize: 'inherit' }}>J</span>
                  <span className="hidden group-hover:inline" style={{ fontFamily: 'inherit', fontSize: 'inherit' }}>JAICE</span>
                </h1>
              ...
              {/* Navigation Buttons */}
                <section aria-label = "Navigation Buttons">
                  <ul className="flex flex-col items-start gap-2" style={{ fontFamily: 'var(--font-subheading)' }}>
                    ...
                    <li>
                      ...
                      >
                        <div className="flex items-center gap-2">
                          <img src={homeIcon} alt="Home" className="w-5 h-5 flex-shrink-0" /> {/* when not hovered (flex-shrink-0 makes the icon not shrink when not hovered) */}
                          <span className="hidden group-hover:inline">Home</span> {/* when hovered */}
                        </div>
                      </Button>
                    </li>
                    ...
                    <li>
                      ...
                      >
                        <div className="flex items-center gap-2">
                          <img src={aboutIcon} alt="About" className="w-5 h-5 flex-shrink-0" /> {/* when not hovered */}
                          <span className="hidden group-hover:inline">About</span> {/* when hovered */}
                        </div>
                      </Button>
                    </li>
                    ...
                    <li>
                      ...
                      >
                        <div className="flex items-center gap-2">
                          <img src={dashboardIcon} alt="Dashboard" className="w-5 h-5 flex-shrink-0" /> {/* when not hovered */}
                          <span className="hidden group-hover:inline">Dashboard</span> {/* when hovered */}
                        </div>
                      </Button>
                    </li>
                ...
                <section aria-label = "Settings and account">
                  <ul className="flex flex-col items-start gap-2" style={{ fontFamily: 'var(--font-subheading)' }}>
                    ...
                    <li>
                      <Button 
                        onClick={() => handleButtonClick("/settings/account", "account")}
                        isSelected={selectedButton === "account"}
                      >
                        <div className="flex items-center gap-2">
                          <img src={accountIcon} alt="Account" className="w-5 h-5 flex-shrink-0" /> {/* when not hovered  */}
                          <span className="hidden group-hover:inline">Account</span> {/* when hovered */}
                        </div>
                      </Button>
                    </li>
                    ...
                    <li>
                      <Button 
                        onClick={() => handleButtonClick("/settings/accessibility", "accessibility")}
                        isSelected={selectedButton === "accessibility"}
                        >
                        <div className="flex items-center gap-2">
                          <img src={accessibilityIcon} alt="Accessibility" className="w-5 h-5 flex-shrink-0" /> {/* when not hovered */}
                          <span className="hidden group-hover:inline">Accessibility</span> {/* when hovered */}
                        </div>
                      </Button>
                    </li>
                    ...
                    <li>
                      <Button 
                        onClick={() => handleButtonClick("/settings/notification", "notification")}
                        isSelected={selectedButton === "notification"}
                        >
                          <div className="flex items-center gap-2">
                            <img src={notificationIcon} alt="Notification" className="w-5 h-5 flex-shrink-0" /> {/* when not hovered */}
                            <span className="hidden group-hover:inline">Notification</span> {/* when hovered */}
                          </div>
                        </Button>
                    </li>
                    ...
                    <li>
                      <Button 
                        ...
                        > 
                        <div className="flex items-center gap-2">
                          <img src={quitIcon} alt="Quit" className="w-5 h-5 flex-shrink-0" /> {/* when not hovered */}
                          <span className="hidden group-hover:inline">Quit</span> {/* when hovered */}
                        </div>
                        </Button>
                    </li>
